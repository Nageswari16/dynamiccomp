...
export declare class DynamicSearchComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<DynamicSearchComponent, [null, null, null, null, null, null, null, null, null, null, null, null, { optional: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DynamicSearchComponent, "app-dynamic-search", never, { "formId": { "alias": "formId"; "required": false; }; "pageId": { "alias": "pageId"; "required": false; }; "componentId": { "alias": "componentId"; "required": false; }; }, { "outerRouting": "outerRouting"; }, never, never, false, never>;
}
