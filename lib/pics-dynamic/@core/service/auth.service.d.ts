...
export declare class AuthService {
    ...
    httpService: any;
    constructor(injector: Injector, store: AuthStore, _router: Router, credentialsService: CredentialsService, localstore: LocalService, _storeservice: DataStoreService);
