...
export declare class DynamicsearchService {
    ...
    SetHttpService(httpService: any): void;
    ...
    rowVersion(data: any): any;
    checkDeleteStatus(pageid: any, id: any, primarytable: any): any;
    checkEditStatus(pageid: any, id: any): any;
    checkRulesInWorkflow(pageData: any): any;
