...
export class DynamicPageComponent {
    ...
    // getPageTabs() {
    //   this.dynamicTabPageService.getPageById(this.formId).subscribe((result: any) => {
    //     if (result) {
