    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'master-view/:masterPageId',
                component: MasterViewComponent,
                loadChildren: () => import('./pics-core-dynamic-master-view.module-11bbc008.mjs').then(m => m.MasterViewModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => import('./pics-core-dynamic-youth-photo.module-a0bf081c.mjs').then(y => y.YouthPhotoModule),
                data: {
                    rootmodulenames: ['YTH'],
                    route: '/youth-photo'
                },
            ...
            {
                path: 'composite-page',
                loadChildren: () => import('./pics-core-dynamic-composite-page.module-e0a4ad75.mjs').then(m => m.CompositePageModule)
            },
            {
                path: 'composite-page/:compositePageId',
                component: CompositePageComponent
...
export { AlertModule as A, CompositePageComponent as C, DynamicPageCleanupComponent as D, HttpService as H, LoaderService as L, MasterViewComponent as M, PrimengModule as P, SharedService as S, ViewYouthPhotoComponent as V, YouthPhotoService as Y, AlertService as a, LocalService as b, LocalStorageService as c, PermissionStore as d, AppService as e, DirectivesModule as f, DynamicSearchModule as g, DynamicSearchComponent as h, DynmicTabPageModule as i, DynamicPageComponent as j, DynamicTabPageService as k, DynamicsearchService as l, DynamicService as m, DynamicComponent as n, CardiDynamicModule as o };
//# sourceMappingURL=pics-core-dynamic-pics-core-dynamic-864536ce.mjs.map
