    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'master-view/:masterPageId',
                component: MasterViewComponent,
                loadChildren: () => import('./pics-core-dynamic-master-view.module-923e6122.mjs').then(m => m.MasterViewModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => import('./pics-core-dynamic-youth-photo.module-17c7c7fd.mjs').then(y => y.YouthPhotoModule),
                data: {
                    rootmodulenames: ['YTH'],
                    route: '/youth-photo'
                },
            ...
            {
                path: 'composite-page',
                loadChildren: () => import('./pics-core-dynamic-composite-page.module-6b685d69.mjs').then(m => m.CompositePageModule)
            },
            {
                path: 'composite-page/:compositePageId',
                component: CompositePageComponent
...
//# sourceMappingURL=pics-core-dynamic-pics-core-dynamic-ff192fe6.mjs.map
