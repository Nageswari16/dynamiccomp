...
class FormPageComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: FormPageComponent, deps: [{ token: i0.Injector }, { token: i1.Router }, { token: i1.ActivatedRoute }, { token: FormioService }, { token: i3$1.Store }, { token: MAT_DIALOG_DATA, optional: true }, { token: PlatformDataStoreService }], target: i0.ɵɵFactoryTarget.Component });
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'master-view/:masterPageId',
                component: MasterViewComponent,
                loadChildren: () => import('./pics-core-dynamic-master-view.module-f1d39fc0.mjs').then(m => m.MasterViewModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => import('./pics-core-dynamic-youth-photo.module-c30d467a.mjs').then(y => y.YouthPhotoModule),
                data: {
                    rootmodulenames: ['YTH'],
                    route: '/youth-photo'
                },
            ...
            {
                path: 'composite-page',
                loadChildren: () => import('./pics-core-dynamic-composite-page.module-79289e6d.mjs').then(m => m.CompositePageModule)
            },
            {
                path: 'composite-page/:compositePageId',
                component: CompositePageComponent
...
//# sourceMappingURL=pics-core-dynamic-pics-core-dynamic-bc9c9e8e.mjs.map
