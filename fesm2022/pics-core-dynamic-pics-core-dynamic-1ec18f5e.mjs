...
import * as i14$1 from '@angular/material/input';
...
import * as i12$2 from 'primeng/fileupload';
...
class VideoSpeechContentService {
...
class TemplateService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: TemplateService, deps: [{ token: i0.Injector }, { token: LocalService }, { token: AlertService }, { token: DynamicsearchService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: TemplateService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.Injector }, { type: LocalService }, { type: AlertService }, { type: DynamicsearchService }]; } });

class ocrResponseService {
    localStorage;
    alertService;
    dynamicSearchService;
    formId;
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: ocrResponseService, deps: [{ token: i0.Injector }, { token: LocalService }, { token: AlertService }, { token: DynamicsearchService }], target: i0.ɵɵFactoryTarget.Injectable });
...
class routeParamService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: routeParamService, deps: [{ token: i1.ActivatedRoute }, { token: LocalService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: routeParamService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.ActivatedRoute }, { type: LocalService }]; } });
...
class FormSubmissionService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: FormSubmissionService, deps: [{ token: i1.ActivatedRoute }, { token: LocalService }, { token: AlertService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: FormSubmissionService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.ActivatedRoute }, { type: LocalService }, { type: AlertService }]; } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: FormPageComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.Injector }, { type: i1.Router }, { type: i1.ActivatedRoute }, { type: FormioService }, { type: TemplateService }, { type: ocrResponseService }, { type: customEventService }, { type: VideoSpeechContentService }, { type: routeParamService }, { type: i3$1.Store }, { type: undefined, decorators: [{
                    type: Optional
                }, {
                    type: Inject,
                    args: [MAT_DIALOG_DATA]
                }] }, { type: PlatformDataStoreService }, { type: FormSubmissionService }]; }, propDecorators: { editId: [{
                type: Input
            }], pageId: [{
                type: Input
            }], sourceid: [{
...
class FileUploadBasicComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "16.2.12", type: FileUploadBasicComponent, selector: "app-file-upload-basic", inputs: { value: "value", disabled: "disabled" }, outputs: { valueChange: "valueChange", formioEvent: "formioEvent" }, ngImport: i0, template: "<p-fileUpload\r\n  #fileUpload\r\n  mode=\"basic\"\r\n  name=\"demo[]\"\r\n  [customUpload]=\"true\"\r\n  chooseLabel=\"Upload\"\r\n  [maxFileSize]=\"1000000\"\r\n  [auto]=\"true\"\r\n  [disabled]=\"isShow\"\r\n  (uploadHandler)=\"onUpload($event, fileUpload)\">\r\n</p-fileUpload>\r\n\r\n<ng-container *ngIf=\"isShow\">\r\n  <p>{{ uploadedFiles?.name }}</p>\r\n  <p-button (click)=\"deleteAttachment(uploadedFiles)\"><em class=\"pi pi-trash\"></em></p-button>\r\n  <p-button (click)=\"viewAttachment(uploadedFiles)\"><em class=\"fa fa-eye\"></em></p-button>\r\n</ng-container>\r\n", styles: ["li{list-style:none}\n"], dependencies: [{ kind: "directive", type: i4.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: i6.Button, selector: "p-button", inputs: ["type", "iconPos", "icon", "badge", "label", "disabled", "loading", "loadingIcon", "raised", "rounded", "text", "plain", "severity", "outlined", "link", "size", "style", "styleClass", "badgeClass", "ariaLabel"], outputs: ["onClick", "onFocus", "onBlur"] }, { kind: "component", type: i12$2.FileUpload, selector: "p-fileUpload", inputs: ["name", "url", "method", "multiple", "accept", "disabled", "auto", "withCredentials", "maxFileSize", "invalidFileSizeMessageSummary", "invalidFileSizeMessageDetail", "invalidFileTypeMessageSummary", "invalidFileTypeMessageDetail", "invalidFileLimitMessageDetail", "invalidFileLimitMessageSummary", "style", "styleClass", "previewWidth", "chooseLabel", "uploadLabel", "cancelLabel", "chooseIcon", "uploadIcon", "cancelIcon", "showUploadButton", "showCancelButton", "mode", "headers", "customUpload", "fileLimit", "uploadStyleClass", "cancelStyleClass", "removeStyleClass", "chooseStyleClass", "files"], outputs: ["onBeforeUpload", "onSend", "onUpload", "onError", "onClear", "onRemove", "onSelect", "onProgress", "uploadHandler", "onImageError"] }] });
}
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'master-view/:masterPageId',
                component: MasterViewComponent,
                loadChildren: () => import('./pics-core-dynamic-master-view.module-2f67ef40.mjs').then(m => m.MasterViewModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => import('./pics-core-dynamic-youth-photo.module-8813deea.mjs').then(y => y.YouthPhotoModule),
                data: {
                    rootmodulenames: ['YTH'],
                    route: '/youth-photo'
                },
            ...
            {
                path: 'composite-page',
                loadChildren: () => import('./pics-core-dynamic-composite-page.module-ac6ebf0b.mjs').then(m => m.CompositePageModule)
            },
            {
                path: 'composite-page/:compositePageId',
                component: CompositePageComponent
...
export { AlertModule as A, CompositePageComponent as C, DynamicPageComponent as D, FormPageComponent as F, HttpService as H, LoaderService as L, MasterViewComponent as M, PrimengModule as P, SharedService as S, ViewYouthPhotoComponent as V, YouthPhotoService as Y, AlertService as a, LocalService as b, LocalStorageService as c, PermissionStore as d, AppService as e, DirectivesModule as f, DynamicSearchModule as g, DynamicSearchComponent as h, DynmicTabPageModule as i, DynamicTabPageService as j, DynamicsearchService as k, DynamicService as l, DynamicComponent as m, CardiDynamicModule as n };
//# sourceMappingURL=pics-core-dynamic-pics-core-dynamic-1ec18f5e.mjs.map
