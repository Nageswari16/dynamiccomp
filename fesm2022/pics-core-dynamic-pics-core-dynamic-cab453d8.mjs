    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'master-view/:masterPageId',
                component: MasterViewComponent,
                loadChildren: () => import('./pics-core-dynamic-master-view.module-4f86fc84.mjs').then(m => m.MasterViewModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => import('./pics-core-dynamic-youth-photo.module-e95f03b9.mjs').then(y => y.YouthPhotoModule),
                data: {
                    rootmodulenames: ['YTH'],
                    route: '/youth-photo'
                },
            ...
            {
                path: 'composite-page',
                loadChildren: () => import('./pics-core-dynamic-composite-page.module-28d29322.mjs').then(m => m.CompositePageModule)
            },
            {
                path: 'composite-page/:compositePageId',
                component: CompositePageComponent
...
//# sourceMappingURL=pics-core-dynamic-pics-core-dynamic-cab453d8.mjs.map
