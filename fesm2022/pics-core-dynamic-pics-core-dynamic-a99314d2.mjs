    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'master-view/:masterPageId',
                component: MasterViewComponent,
                loadChildren: () => import('./pics-core-dynamic-master-view.module-972e2441.mjs').then(m => m.MasterViewModule)
            },
            {
            ...
            },
            {
                ...
                loadChildren: () => import('./pics-core-dynamic-youth-photo.module-041dcabe.mjs').then(y => y.YouthPhotoModule),
                data: {
                    rootmodulenames: ['YTH'],
                    route: '/youth-photo'
                },
            ...
            {
                path: 'composite-page',
                loadChildren: () => import('./pics-core-dynamic-composite-page.module-f2c6a122.mjs').then(m => m.CompositePageModule)
            },
            {
                path: 'composite-page/:compositePageId',
                component: CompositePageComponent
...
//# sourceMappingURL=pics-core-dynamic-pics-core-dynamic-a99314d2.mjs.map
